...
def login():
    ...
    if request.form['submit'] == 'login':
        ...
        if user is not None and user.password == password and user.name != 'skirma':
            ...
            bookdata = pd.read_sql('book', 'postgres://ltpogxzhuksxtp:ec2082a42b945845f309a7cae8dc6bb6619c9774369d31b13a6')
...
def pasirinkimas():
    if request.form['submit'] == 'operations':
        operdata = pd.read_sql('operations', 'postgres://ltpogxzhuksxtp:ec2082a42b945845f309a7cae8dc6bb6619c9774369d31b13a6')
        ...
        finishdata = pd.read_sql('finishedbook', 'postgres://ltpogxzhuksxtp:ec2082a42b945845f309a7cae8dc6bb6619c9774369d31b13a6')
